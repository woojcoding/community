...
import com.portfolio.community.security.custom.DelegatedAuthenticationEntryPoint;
import com.portfolio.community.security.custom.UserAccessDeniedHandler;
import com.portfolio.community.security.custom.UserAuthenticationFailureHandler;
import com.portfolio.community.security.filters.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.apply(new CustomFilterConfigurer())
                ...
                .authenticationEntryPoint(
                        new DelegatedAuthenticationEntryPoint(errorResponder))
